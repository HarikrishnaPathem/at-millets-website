...
const leadersData = [
  ...
  },
  {
    ...
    bio: "Vanguri Kavitha Gandhi is an entrepreneur and director specializing in millet-based food processing and healthy nutrition solutions. She brings over five years of hands-on farming experience, combining strong field-level knowledge with a deep understanding of natural and sustainable agricultural practices. In addition to her agri-business expertise, she has more than 10 years of experience in the banking and NBFC sector, having served in senior sales and operational management roles with reputed institutions including Axis Bank, Muthoot Fincorp, India Infoline, and FedBank Financial Services. This extensive financial and operational background enables her to effectively manage business strategy, compliance, and scalable growth. She oversees end-to-end operations across millet flour, rava, ready-to-cook, and ready-to-eat product segments, including sourcing, processing, quality control, packaging, and branding. Driven by a farm-to-home vision, she focuses on building sustainable food brands that empower farmers, strengthen local economies, and promote nutritious living.",
  },
  {
